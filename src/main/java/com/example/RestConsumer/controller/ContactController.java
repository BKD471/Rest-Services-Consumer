...
import com.example.RestConsumer.model.Response;
import com.example.RestConsumer.proxy.ContactProxy;
...
public class ContactController {
    ...
    public Mono<Response> saveMessage(@RequestBody Contact contact){
        String uri="http://localhost:8080/api/contact/saveMsg";
        return webClient.post().uri(uri).header("invocationFrom","WebClient").
                body(Mono.just(contact), Contact.class).retrieve().bodyToMono(Response.class);
    }
